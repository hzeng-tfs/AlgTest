...
namespace AlgLibTest
{
   ...
   public static class TestData
   {
      ...
      public static Sample FeKbFull = new Sample("FeKb full peak, strong",
         new double[] { 32, 44, 43, 50, 41, 53, 43, 50, 51, 67, 82, 90, 103, 138, 210, 311, 
                        400, 523, 698, 886, 1245, 1532, 1882, 2152, 2350, 2629, 2745, 2718, 2578, 2329, 2075, 1750, 1527, 1196, 876, 633, 466,
                        286, 204, 135, 81, 38, 17, 28, 12, 10, 10, 13 },
         475, 501.91, 11.73);

      public static Sample FeKbPartial = new Sample("FeKb partial peak, strong",
         new double[] { 400, 523, 698, 886, 1245, 1532, 1882, 2152, 2350, 2629, 2745, 2718, 2578, 2329, 2075, 1750, 1527, 1196, 876, 633, 466 },
         491, 501.91, 11.73);

      public static Sample BrKaFull = new Sample("BrKa full peak, weak",
         new double[] { 19, 11, 11, 19, 23, 22, 15, 25, 20, 27, 28, 38, 34, 29, 44, 58, 55, 74, 104, 
                        122, 145, 195, 227, 309, 378, 464, 476, 477, 613, 575, 616, 641, 580, 551, 522, 468, 439, 359, 286, 256, 183, 129, 105, 
                        95, 78, 46, 42, 31, 26, 17, 17, 17, 7, 20, 14, 18, 11, 18, 11, 15, 17, 14 },
         816, 846.88, 15.17);

      public static Sample BrKaPartial = new Sample("BrKa Partial peak, weak",
         new double[] { 122, 145, 195, 227, 309, 378, 464, 476, 477, 613, 575, 616, 641, 580, 551, 522, 468, 439, 359, 286, 256, 183, 129, 105 },
         835, 846.88, 15.17);
